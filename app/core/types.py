...
class DealRepositoryProtocol(Protocol):
    ...
    async def mark_channel_access_granted(self, deal_id: DealId) -> Deal | None: ...
    async def record_channel_access_error(self, deal_id: DealId, error: str) -> None: ...
    async def request_channel_release(self, deal_id: DealId) -> Deal | None: ...
