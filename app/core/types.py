...
from app.models.entities import BotSettings, CollectionAttempt, Deal, DisputeTicket, PayoutAttempt, RefundAttempt, User
...
class PayoutRepositoryProtocol(Protocol):
    ...
    async def mark_confirmed(self, attempt_id: int, delivery_deadline: datetime) -> Deal | None: ...
