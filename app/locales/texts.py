...
TEXTS: dict[Language, dict[TextKey, str]] = {
    Language.RU: {
        TextKey.MAIN_MENU_CAPTION: (
            ...
            "<tg-emoji emoji-id='6028226658543082010'>🔨</tg-emoji> <b>Контроль:</b>\n"
            "Спор, возврат и средства не освобождаются просто по таймеру — "
            "<b>есть последовательность состояний сделки.</b>\n\n"
