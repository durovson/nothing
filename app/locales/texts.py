...
TEXTS: dict[Language, dict[TextKey, str]] = {
    Language.RU: {
        TextKey.MAIN_MENU_CAPTION: (
            ...
            "После подтвержения обеями сторонами средства переводятся получателю.\n\n"
            "<tg-emoji emoji-id='6028226658543082010'>🔨</tg-emoji> <b>Важно:</b>\n"
            "<b>GRNT выступает нейтральным гарантом и сопровождает только сделки, соответсвующие нашим правилам и политике Telegram.</b>\n\n"
        ...
        TextKey.FAQ_CAPTION: (
            ...
            "1. Основное\n"
            "<blockquote>GRNT — это гарант-сервис (escrow), обеспечивающий безопасные сделки между пользователями. Средства блокируются до завершения сделки и выпускаются только после подтверждения обеями сторонами./blockquote>\n\n"
            "2. Как это работает\n"
            ...
            "4. Подтвердите выполнение — после выполнения условий обе стороны подтвреждают.\n"
            "5. Разблокировка — средства автоматически отправляются получателю.</blockquote>\n\n"
            "3. Обязанности сторон\n"
            "<blockquote>• Все условия сделки должны быть согласованы до ее начала.\n"
            "• Участники обязаны предоставлять доказательства выполнения условий при возникновении спора.\n"
            "• GRNT не несет ответсвенности за мошенничество, внешние переписки и сделки вне сервиса.</blockquote>\n\n"
            "4. Арбитраж и споры\n"
           "<blockquote>• При разногласиях стороны могут запросить арбитраж GRNT.\n"
            ...
            "5. Запрещенные сделки\n"
            "<blockquote>Гарант GRNT не поддерживает:\n"
            "• Продажу запрещенных товаров и услуг\n"
            "• Скам, фишинг, обман\n"
            "• Сделки, нарушающие законы или правила Telegram\n"
            "• Переводы и расчеты вне сервиса</blockquote>\n\n"
            "6. Комиссия\n"
            "<blockquote>• Комиссия GRNT состовляет 1% и удерживается автоматически при завершении сделки.</blockquote>\n\n"
            "7. Ответственность\n"
           "<blockquote>• GRNT выступает только как нейтральный посредник.\n"
            "• Вся отвественность за достоверность информации и действий лежит на участниках сделки.</blockquote>\n\n"
    ...
    Language.EN: {
        TextKey.MAIN_MENU_CAPTION: (
            ...
            "Payments are verified automatically on the TON network.\n\n"
            "<tg-emoji emoji-id='6028530359975548369'>💎</tg-emoji> <b>TON / USDT:</b>\n"
            "One system for both assets.\n\n"
            "<tg-emoji emoji-id='6028226658543082010'>🔨</tg-emoji> <b>Control:</b>\n"
            "Disputes, refunds, and funds are not released merely by a timer — "
            "<b>the deal follows a defined sequence of states.</b>\n\n"
            "<tg-emoji emoji-id='5985630530111020079'>💬</tg-emoji> <b>1%:</b>\n"
