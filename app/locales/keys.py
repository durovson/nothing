...
class TextKey(StrEnum):
    ...
    OTC_OFFER_PROMPT = "otc_offer_prompt"
    OTC_OFFER_SENT = "otc_offer_sent"
    OTC_OFFER_INCOMING = "otc_offer_incoming"
    OTC_OFFER_RESULT = "otc_offer_result"
    OTC_OFFER_UNAVAILABLE = "otc_offer_unavailable"
    OTC_OFFER_INVALID_AMOUNT = "otc_offer_invalid_amount"
    OTC_OFFER_COOLDOWN = "otc_offer_cooldown"
    OTC_OFFER_ALREADY_RESOLVED = "otc_offer_already_resolved"
    OTC_OFFER_ACCEPT_BUTTON = "otc_offer_accept_button"
    OTC_OFFER_DECLINE_BUTTON = "otc_offer_decline_button"
    OTC_OFFER_PROFILE_BUTTON = "otc_offer_profile_button"
